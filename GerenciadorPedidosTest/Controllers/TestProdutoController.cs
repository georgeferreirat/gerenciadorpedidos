...
{
    public class TestProdutoController : DbTest
    {
        private ProdutoRepository _produtoRepository;
        private readonly IMapper _mapper;

        public TestProdutoController()
        {
        ...
        public void TestgetALL_Return200()
        {
            ...
            var controller = new ProdutoController(_produtoRepository, _mapper);

            var result = controller.getALL();

            result.Should().BeOfType<OkObjectResult>();
            var objectResult = (OkObjectResult)result;
            objectResult.Value.Should().BeOfType<List<ProdutoDto>>();
        }
        ...
        public void Testget_Return200()
        {
            ...
            result.Should().BeOfType<OkObjectResult>();
            var objectResult = (OkObjectResult)result;
            objectResult.Value.Should().BeOfType<Produto>();
        }
        ...
        public void TestCreate_Return200()
        {
            ...
            var result = controller.Create(new ProdutoDto()
            {
        ...
        public void TestUpdate_Return204()
        {
            ...
            var result = controller.Update(1, new ProdutoDto()
            {
                DataCadastro = DateTime.Now,
                Descricao = "Descrição de Teste",
                Id = 1,
        ...
        public void TestUpdate_Return404()
        {
            ...
            var result = controller.Update(0, new ProdutoDto()
            {
                DataCadastro = DateTime.Now,
                Descricao = "Descrição de Teste",
                Id = 0,
