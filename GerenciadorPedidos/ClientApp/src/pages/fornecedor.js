...
const Fornecedor = () => {
    ...
    function getall() {
        ...
        fetch("https://localhost:7228/api/Fornecedor", requestOptions)
            .then(res => {
                console.log(res);
                return res.json();
            })
    ...
    function editar(id) {
      ...
      fetch("https://localhost:7228/api/Fornecedor/"+id)
      .then(res => res.json())
      .then(
          (data) => {
    ...
    function update(id, fornecedor) {
      ...
      fetch('https://localhost:7228/api/Fornecedor/'+id, requestOptions)
